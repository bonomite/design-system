import sbEmbedBlock from '../sb-embed-block.vue'

export default {
  title: 'Components/sb-embed-block',
  component: sbEmbedBlock,
  argTypes: {
...
const Template = (args) => ({
  components: { sbEmbedBlock },
  setup() {
    return { args }
  },
  template: '<sb-embed-block v-bind="args" />',
})
